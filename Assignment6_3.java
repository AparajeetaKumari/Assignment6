...
public class Assignment6_3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		save.click();
        enterpassword = driver.findElement(By.xpath("(//input[@type='password'])[1]"));
		js.executeScript("arguments[0].value=arguments[1]",enterpassword,passwordIs);
	
		
		confirmPassword = driver.findElement(By.xpath("(//input[@type='password'])[2]"));
		js.executeScript("arguments[0].value=arguments[1]",confirmPassword,passwordIs);
		
		save.click();
		
		//not able to proceed due to website issue
